...
public class RenderBatch {
    ...
    public void addSprite(SpriteRenderer spriteRenderer) {
        // get index and add renderObject (in this case, a sprite renderer)
    ...
    public void render() {
        ...
        // use shader
        shader.use();
        shader.uploadMat4f("uniformProjectionMatrix", Window.getScene().camera().getProjectionMatrix());
        shader.uploadMat4f("uniformViewMatrix", Window.getScene().camera().getViewMatrix());
    ...
    private void loadVertexProperties(int index) {
        ...
        Vector2f[] texCoords = spriteRenderer.getTextCoords();
        ...
        // add the 4 vertices with the appropriate properties
        float xAdd = 1.0f;
        float yAdd = 1.0f;
    ...
    private void loadElementIndices(int[] elements, int index) {
        ...
        int offset = 4 * index; // end of triangle 1
